...
const Tasks = (): JSX.Element => {
  return (
    <div className="mb-4 mx-0 mr-4 relative cursor-not-allowed">
      ...
      <span className="absolute transform -translate-y-1/2 top-1/2 left-1/2 -translate-x-1/2 text-red-500 bg-red-100 p-3 rounded-lg font-bold opacity-80 transform -rotate-12">
