        ...
        {isLoading ? (
          ...
          <>
            <Popover as="div" className="relative inline-block text-left">
              ...
              >
                <Popover.Panel className="z-20 top-20 text-lg absolute right-4 w-96 origin-top-right bg-white divide-y divide-gray-100 rounded-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <div className="px-1 py-1 ">
                    ...
                    <div>
                      <div className="border-b-2 text-xl">
                        ...
                        <span className="p-2 flex justify-between items-center hover:bg-purple-100">
                          <p className="flex-grow">admin.1@gmail.com</p>
                          <DocumentDuplicateIcon
                            className="hover:bg-green-100 hover:text-green-500 transition-all h-8 ml-4 rounded-lg cursor-pointer transform scale-100 hover:scale-105 active:scale-100"
                            onClick={() => {
                        ...
                        <span className="p-2 flex justify-between items-center hover:bg-purple-100">
                          ...
                          <DocumentDuplicateIcon
                            className="hover:text-green-500 hover:bg-green-100 transition-all h-8 ml-4 rounded-lg cursor-pointer transform scale-100 hover:scale-105 active:scale-100"
                            onClick={() => {
