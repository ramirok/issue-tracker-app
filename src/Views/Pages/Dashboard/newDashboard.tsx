...
import { getProjects } from "../../../Controllers/Redux/projectSlice";
          ...
          <div className="bg-white h-full rounded-2xl pb-4">
            <nav>
              ...
              <NavLink
                exact
                to="/app/dashboard"
                className="w-full font-thin uppercase text-gray-500  flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-yellow-500"
                activeClassName="text-yellow-500 bg-gradient-to-r from-white to-yellow-100 border-r-4 border-yellow-500 border-r-4 border-yellow-500"
              >
            ...
            <div className="relative flex flex-col justify-center h-full px-3 mx-auto flex-center">
              <div className="relative items-center pl-1 flex justify-between w-full lg:max-w-68 sm:pr-2 sm:ml-0">
                ...
                <div className="relative flex items-center w-full lg:w-96 h-full group">
                  ...
                  <input
                    type="text"
                    className="h-12 block w-full pl-10 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-yellow-500 ring-opacity-90 bg-gray-100 text-gray-600 aa-input"
                    placeholder="Search"
                  />
                </div>
                {/* profile button */}
                <Menu as="div" className="ml-4 flex justify-center">
                  <Menu.Button>
                    <UserIcon className="h-12 w-12 border rounded-full bg-gray-200 p-1" />
                  </Menu.Button>
                  <Transition
                    as={Fragment}
                    enter="transition ease-out duration-100"
