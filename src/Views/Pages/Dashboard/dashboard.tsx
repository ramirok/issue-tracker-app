...
const Dashboard = ({
  ...
  useEffect(() => {
    getAccessTokenSilently().then((token) => {
      ...
      fetchTickets(token).then((response) => {
                              ...
                              <div
                                ...
                                className={`${
                                  active
                                    ...
                                    : "text-gray-900"
                                } group flex rounded-lg items-center w-full px-2 py-2 justify-between mb-2 cursor-not-allowed	`}
                              >
                                PROFILE
